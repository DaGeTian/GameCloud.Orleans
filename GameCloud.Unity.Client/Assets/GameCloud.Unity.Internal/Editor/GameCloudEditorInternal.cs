...
public class GameCloudEditorInternal : EditorWindow
{
    ...
    static void exportGameCloudUnityNativeDataEye()
    {
        ...
        arr_assetpathname[2] = "Assets/Plugins/GameCloud.Unity.Native/DataEye";
        arr_assetpathname[3] = "Assets/Plugins/GameCloud.Unity.Native/SDKReceiveMono";
    ...
    static void exportUnityNativePay()
    {
        ...
        arr_assetpathname[0] = "Assets/GameCloud.Unity.Native";
        arr_assetpathname[1] = "Assets/Plugins/Android";
        arr_assetpathname[2] = "Assets/Plugins/GameCloud.Unity.Native/Pay";
        arr_assetpathname[3] = "Assets/Plugins/GameCloud.Unity.Native/SDKReceiveMono";
    ...
    static void exportGameCloudNativeBySelf()
    {
        ...
        arr_assetpathname[0] = "Assets/GameCloud.Unity.Native";
        arr_assetpathname[1] = "Assets/Plugins/Android";
        arr_assetpathname[2] = "Assets/Plugins/GameCloud.Unity.Native/Native";
        arr_assetpathname[3] = "Assets/Plugins/GameCloud.Unity.Native/SDKReceiveMono";
    ...
    static void exportBaiduSpeech()
    {
        ...
        arr_assetpathname[0] = "Assets/GameCloud.Unity.Native";
        arr_assetpathname[1] = "Assets/Plugins/Android";
        arr_assetpathname[2] = "Assets/Plugins/GameCloud.Unity.Native/Speech";
        arr_assetpathname[3] = "Assets/Plugins/GameCloud.Unity.Native/SDKReceiveMono";
