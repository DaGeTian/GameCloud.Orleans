...
namespace GameCloud.Unity.Common
{
    ...
    public abstract class ISqlite
    {
        ...
        //---------------------------------------------------------------------
        public abstract HashSet<string> getAllTableName(string sqlite_query);

        //---------------------------------------------------------------------
        public abstract Dictionary<int, object> getAllTableData(string sqlite_query);

        //---------------------------------------------------------------------
        public abstract Dictionary<int, List<DataInfo>> getTableData(string sqlite_query);
...
public class SqliteUnity : ISqlite
{
    ...
    //---------------------------------------------------------------------
    public override HashSet<string> getAllTableName(string sqlite_query)
    {
